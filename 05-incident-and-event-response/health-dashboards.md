# AWS Health Dashboards: Previously called AWS Service Health Dashboard
...
- In order to ensure services are healthy in AWS we have the following services:
    ...
    - **AWS Health Dashboard: Previously called AWS Personal Health Dashboard (PHD)**:
...
- These are possible for account events and public events (regional availability of a service)
