...
- These are automated checks to identify hardware & software issues
- There are 2 types of status checks:
    - **System Status Checks**:
        ...
        - As a resolution, we can stop and start the affected instances. The instance will then be migrated to another host.
...
- Recovery option 2: use an Auto Scaling Group
    ...
    - This wouldn't keep the same private and EIP assigned to the instances
